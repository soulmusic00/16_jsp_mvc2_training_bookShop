...
<form id="upForm1" action="${contextPath}/mg/bookUpdatePro.do" method="post" enctype="multipart/form-data">
<div id="bookUpdateForm" class="box">
   <ul>
      ...
      <li>
          ...
          <input id="discount_rate" name="discount_rate" type="text" size="5" maxlength="2" value="${book.discount_rate}">  
      </li>
      <li class="label2">
